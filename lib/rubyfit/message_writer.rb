  ...
  MESSAGE_DEFINITIONS = {
    ...
    lap: {
      ...
      fields: {
        ...
        sport_code: { id: 25, type: RubyFit::Type.enum, values: RubyFit::MessageConstants::SPORT.merge(RubyFit::MessageConstants::SPORT.values.map { |v| [v, v] }.to_h), required: false },
        norm_pwr_watts: { id: 33, type: RubyFit::Type.uint16 },
        sub_sport_code: { id: 39, type: RubyFit::Type.enum, values: RubyFit::MessageConstants::SUBSPORT.merge(RubyFit::MessageConstants::SUBSPORT.values.map { |v| [v, v] }.to_h), required: false},
    ...
    wahoo_clm: {
      ...
      fields: {
        ...
        data: { id: 3, type: RubyFit::Type.byte_array(35), required: true }
      }
    },
