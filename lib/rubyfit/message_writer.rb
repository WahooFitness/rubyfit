  ...
  MESSAGE_DEFINITIONS = {
    ...
    lap: {
      ...
      fields: {
        ...
        tot_ascent_m: { id: 21, type: RubyFit::Type.uint16 },
        tot_descent_m: { id: 22, type: RubyFit::Type.uint16 },
    ...
    session: {
      ...
      fields: {
        ...
        tot_ascent_m: { id: 22, type: RubyFit::Type.uint16 },
        tot_descent_m: { id: 23, type: RubyFit::Type.uint16 },
