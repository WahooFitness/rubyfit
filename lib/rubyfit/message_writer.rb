  ...
  MESSAGE_DEFINITIONS = {
    ...
    lap: {
      ...
      fields: {
        ...
        avg_speed_mps: { id: 13, type: RubyFit::Type.uint32_scale100 },
        max_speed_mps: { id: 14, type: RubyFit::Type.uint32_scale100 },
        ...
        tot_ascent_m: { id: 21, type: RubyFit::Type.altitude },
        tot_descent_m: { id: 22, type: RubyFit::Type.altitude },
    ...
    record: {
      ...
      fields: {
        timestamp: { id: 253, type: RubyFit::Type.timestamp, required: true },
        lat_deg: { id: 0, type: RubyFit::Type.semicircles, required: true },
        lon_deg: { id: 1, type: RubyFit::Type.semicircles, required: true },
        ...
        spd_mps: { id: 6, type: RubyFit::Type.speed },
    ...
    session: {
      ...
      fields: {
        ...
        tot_dist_m: { id: 9, type: RubyFit::Type.centimeters },
        tot_cal: { id: 11, type: RubyFit::Type.uint16 },
        avg_spd_mps: { id: 14, type: RubyFit::Type.uint32_scale100 },
        max_speed_mps: { id: 15, type: RubyFit::Type.uint32_scale100},
        ...
        tot_ascent_m: { id: 22, type: RubyFit::Type.altitude },
        tot_descent_m: { id: 23, type: RubyFit::Type.altitude },
