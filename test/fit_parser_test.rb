...
class FitParserTest < Minitest::Test
  ...
  def test_little_endian_file_decoding
    ...
    parser.parse(raw) do |data|
      ...
      assert_equal(2, json_output['sessions'][0]['sport'])
      assert_equal(6, json_output['sessions'][0]['sub_sport'])
      assert_equal(247.886, json_output['sessions'][0]['total_timer_time'])
      assert_equal(17, json_output['sessions'][0]['total_calories'])
      assert_equal(137, json_output['sessions'][0]['max_heart_rate'])
      assert_equal(108, json_output['sessions'][0]['avg_heart_rate'])
      assert_equal(124.2, json_output['sessions'][0]['total_distance'])
      assert_equal(2.1, json_output['sessions'][0]['training_stress_score'])
      assert_equal(0.592, json_output['sessions'][0]['intensity_factor'])
      assert_equal(124, json_output['sessions'][0]['threshold_power'])

      assert_equal([202.88, 46.528, 0, 0, 0], json_output['laps'][0]['time_in_hr_zone'])
      assert_equal([205.307, 2.88, 35.999, 0.0, 0.0, 0.0], json_output['laps'][0]['time_in_power_zone'])

      assert_equal(2, json_output['laps'][0]['sport'])
      assert_equal(6, json_output['laps'][0]['sub_sport'])
      assert_equal(247.886, json_output['laps'][0]['total_timer_time'])
      assert_equal(17, json_output['laps'][0]['total_calories'])
      assert_equal(137, json_output['laps'][0]['max_heart_rate'])
      assert_equal(108, json_output['laps'][0]['avg_heart_rate'])
      assert_equal(124.2, json_output['laps'][0]['total_distance'])
      assert_equal(17304, json_output['laps'][0]['total_work'])
      assert_equal([202.88, 46.528, 0, 0, 0], json_output['laps'][0]['time_in_hr_zone'])
      assert_equal([205.307, 2.88, 35.999, 0.0, 0.0, 0.0], json_output['laps'][0]['time_in_power_zone'])

      assert_equal(98, json_output['records'][1]['heart_rate'])
      assert_equal(0, json_output['records'][1]['power'])
      assert_equal(0, json_output['records'][1]['calories'])
      assert_equal(85, json_output['records'][0]['battery_soc'])

      assert_equal(85, json_output['records'][0]['battery_soc'])
      assert_equal(110, json_output['records'][242]['power'])
      assert_equal(124.2, json_output['records'][242]['distance'])
      assert_equal(0.134, json_output['records'][242]['speed'])
      ...
      assert_equal(68, json_output['pwr_zones'][0]['high_value'])
      assert_equal(87, json_output['pwr_zones'][1]['high_value'])
      assert_equal(113, json_output['pwr_zones'][2]['high_value'])
      assert_equal(119, json_output['pwr_zones'][3]['high_value'])
      assert_equal(128, json_output['pwr_zones'][4]['high_value'])
      assert_equal(65534, json_output['pwr_zones'][5]['high_value'])
