...
class FitParserTest < Minitest::Test
  ...
  def test_little_endian_file_decoding
    ...
    parser.parse(raw) do |data|
      ...
      assert_equal(2, json_output['workouts'][0]['sport'])
      assert_equal(6, json_output['workouts'][0]['sub_sport'])
      assert_equal('Indoor Cycling', json_output['workouts'][0]['wkt_name'])

      assert_equal('WAHOOAPPIOS62BB', json_output['wahoo_ids'][0]['app_token'])
      assert_equal(3, json_output['wahoo_ids'][0]['workout_num'])
      assert_equal(12, json_output['wahoo_ids'][0]['workout_type'])
      ...
      assert_equal(6, json_output['power_zones'].size)
      assert_equal(0, json_output['power_zones'][0]['message_index'])
      assert_equal(1, json_output['power_zones'][1]['message_index'])
      assert_equal(2, json_output['power_zones'][2]['message_index'])
      assert_equal(3, json_output['power_zones'][3]['message_index'])
      assert_equal(4, json_output['power_zones'][4]['message_index'])
      assert_equal(5, json_output['power_zones'][5]['message_index'])

      assert_equal(68, json_output['power_zones'][0]['high_value'])
      assert_equal(87, json_output['power_zones'][1]['high_value'])
      assert_equal(113, json_output['power_zones'][2]['high_value'])
      assert_equal(119, json_output['power_zones'][3]['high_value'])
      assert_equal(128, json_output['power_zones'][4]['high_value'])
      assert_equal(65534, json_output['power_zones'][5]['high_value'])
